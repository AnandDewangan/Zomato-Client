...
class Filter extends Component {
  ...
  componentDidMount = async () => {
    ...
    const restuarant = await axios({
      method: "POST",
      url: "https://server-lake-zeta.vercel.app/filter",
  ...
  render() {
    ...
    let result =
      currentRestuarant && currentRestuarant.length > 0 ? (
        currentRestuarant.map((item) => {
          return (
            <div
              className="col-sm-12"
            ...
            >
              ...
              >
                ...
                >
                  <h2 style={{ fontWeight: "600", color: "#192f60" }}>
                    {" "}
                    {item.name}{" "}
                  </h2>
                  <h4
                ...
                <div style={{ display: "inline-block", margin: "30px" }}>
                  <h4 className="h4-tag" style={{ color: "#636f88" }}>
                    CUISINES:
                  </h4>
                  <h4 className="h4-tag" style={{ color: "#636f88" }}>
                    COST FOR TWO:
                ...
                >
                  <h4 className="h4-tag" style={{ color: "#192f60" }}>
                    {item.cuisine_id.map((cuis) => cuis.name + " ")}
                  </h4>
                  <h4 className="h4-tag" style={{ color: "#192f60" }}>
                    ₹{item.cost}
                  </h4>
        ...
        <div
          style={{ fontSize: "30px", marginLeft: "auto", marginRight: "auto", textShadow: "2px 2px 5px red", color: "white" }}
        >
          No results found ...
        </div>
      );
    ...
    if (currentPage === 1 && pageNumbers.length > 1) {
      prevButton = (
        <li className="page-list disabled">
    ...
    return (
      <React.Fragment>
        ...
        <div className="container" style={{ marginTop: "100px" }}>
          ...
          >
            {this.state.option} Places in New Delhi
          </h1>
