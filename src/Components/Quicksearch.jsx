  ...
  handleClick = (id, name) => {
    ...
    if (location_id) {
      this.props.history.push(
        `/filter?mealtype=${id}&mealtype_name=${name}&location=${location_id}`
      );
    ...
    return (
      <div>
        <div className="container">
          <img
            src="https://b.zmtcdn.com/data/o2_assets/cf8a75f38e24a66e674c0c9ff962bc3e1619590647.png?output-format=webp"
            width="100%"
            height="100%"
            style={{ marginTop: "50px", borderRadius: "1.2rem" }}
          />
            ...
            {quicksearch.map((item) => {
              return (
                <div
                  ...
                  onClick={() => this.handleClick(item.mealtype_id, item.name)}
                >
